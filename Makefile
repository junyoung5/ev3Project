all: ev3dev.a execute.o h_crane.o
	arm-linux-gnueabi-g++-4.7 -L. -o execute execute.o h_crane.o -lev3dev
...
execute.o: execute.cpp
		arm-linux-gnueabi-g++-4.7 -c execute.cpp -o execute.o -std=c++11 -D_GLIBCXX_USE_NANOSLEEP
